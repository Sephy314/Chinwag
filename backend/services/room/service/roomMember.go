...
func NewRoomMemberService(roomMemberRepo repo.RoomMemberRepoInterface, roomRepo repo.RoomRepoInterface, user UserProvider, uow ...repo.UnitOfWork) *RoomMemberService {
